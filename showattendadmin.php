...
<div>
	<form method="POST">
		<label>From: </label><input type="date" style="margin-top:20px;height:30px;width:120px"  name="from">
		<label>To: </label><input type="date" style="margin-top:20px;height:30px;width:120px"  name="to">
		<input type="submit" value="Get Data" style="margin-top:20px;height:30px;width:120px"  name="submit">
	</form>
</div>
	...
	<table style="margin-left:px" border="1" cellspacing="8px" color="white">
		...
		<?php
			if (isset($_POST['submit'])){
				...
				$oquery=$conn->query("select * from empatt where ddd between '$from' and '$to'");
...
<a href="third.php"><input type="button" id="logout" style="margin-top:20px;height:30px;width:80px" value="Log Out"></a>
<div></center>
</body>
</html>