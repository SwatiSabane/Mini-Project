...
<?php
  ...
  // Create connection
	...
	{  
		echo '<h1 style="color:white; margin-left:20px; margin-top:50px; font-family:Times New Roman;"> You have sucessfully loggedIn as a Administrator</h1>';
...
<body>
<p id="demo"></p>
<button type="submit" class="btn btn-light" name="btnLogin" style="margin-left:20px" onclick="getLocation()">Mark Attendance</button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<a href="register_php.php"><input type="button" class="btn btn-light" style="margin-left:20px" id="show" value="Register New User"></a>

<a href="showattendstud.php"><input type="button" class="btn btn-light" style="margin-left:20px" id="show" value="Show Attendance"></a>
<a href="showattendadmin.php"><input type="button" class="btn btn-light" style="margin-left:20px" id="show" value="All Emp Report"></a>
<a href="deleteUser.php"><input type="button" class="btn btn-light" style="margin-left:20px" id="show" value="Delete User"></a>
